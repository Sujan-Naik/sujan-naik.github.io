        ...
        <>
            ...
            <PrimaryCard >
                ...
                {selectedItem === 'gameDev' && <div>You selected Video Game Development & Design.
                    ...
                    <blockquote>
                        <li>A 3D Roguelike Video Game written in Unity for my final year Computer Science BSc project as part of a knowledge exchange project with IBM.</li>
                ...
                <p>I have a reasonable amount of experience in a variety of frameworks, technologies and languages.</p>
                <h1> My Web Dev Projects/Experience (by recency)</h1>
                    ...
                    <li>
                        A spin-off of the well known PollEverywhere aimed towards Informatics lecturers developed using the MERN stack.
                    </li>
                    <li>
                ...
                {selectedItem === 'modding' && <div>You selected Game Modding.
                    ...
                    <p>SonorousMC is the name of my Minecraft network, featuring a ProjectKorra server, Modpack server and my Main MMORPG Fantasy Project server! </p>
                    <PrimaryAccordion>
                        <AccordionItem title={"MMORPG Fantasy Project server"}>
                            <div>
                        <h2><a href="https://github.com/SonorousMinecraft/SonorousAbilities">Abilities</a> (alpha)</h2>
                        <blockquote>
                            <p>A groundbreakingly complex ability system, heavily inspired by <a
                                href="https://projectkorra.com/">Project Korra</a> but written from scratch and aims to
                                do things a different way.</p>
                            <p>Consists of Archetypes (the name for classes) such as Earth, Ocean, Sky, Sun, Chaos
                                etc.</p>
                            <p>Makes use of block displays and item displays released in Minecraft 1.19.4 to create
                    ...
                    <div>
                        <h2><a href="https://github.com/SonorousMinecraft/SonorousRPG">RPG</a> (skill system at vertical
                            slice, other features not implemented yet)</h2>
                        <blockquote>
                            <p>The centerpiece of the server, skill system, custom enchantments, custom items, etc.</p>
                    ...
                    <div>
                        ...
                        <blockquote>
                            <p>An entirely revamped world generation from scratch designed to rejuvenate the world.</p>
                            <p>Uses noise to generate more coherent continent based land masses with intuitive biome
                                placement.</p>
                            <p>Custom tree generation (large ones) using fractal noise.</p>
                            <p>Structure generation using WorldEdit Schematics.</p>
                            <p>Procedurally generated Kingdoms that can place entities, using WorldEdit schematic
                                buildings.</p>
                        </blockquote>
                    </div>

                    <div>
                        <h2><a href="https://github.com/SonorousMinecraft/SonorousMobs">Mobs</a> (pre-alpha but probably
                    ...
                    <div>
                        <h2><a href="https://github.com/SonorousMinecraft/SonorousModels">Models</a> (still early
                            stages)</h2>
                        <blockquote>
                            <p>A new idea I had to figure out how to make modded Models in Minecraft as a plugin.</p>
                            <p>This will at some stage be used with Mobs.</p>
                        </blockquote>
                    </div>

                    <div>
                        <h2><a href="https://github.com/SonorousMinecraft/SonorousNPCs">NPCs</a> (needs to be redone
                            largely)</h2>
                        <blockquote>
